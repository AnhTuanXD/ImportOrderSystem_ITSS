...
public class DangNhapBoundary {
    private final AppContext context;
    private final Consumer<NguoiDung> onLogin;

    public DangNhapBoundary(AppContext context, Consumer<NguoiDung> onLogin) {
    ...
    public Parent build() {
        ...
        login.setOnAction(event -> context.getXacThucController()
